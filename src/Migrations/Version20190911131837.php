 ...
 */
final class Version20190911131837 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, id_categorie_id INT NOT NULL, nom_article VARCHAR(255) DEFAULT NULL, image_article VARCHAR(40) DEFAULT NULL, prix_article DOUBLE PRECISION DEFAULT NULL, description_article LONGTEXT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, INDEX IDX_23A0E669F34925F (id_categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
